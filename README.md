...
Official implementation of **Context-Aware Subgraph Explanations for Multi-Task GNNs** using PyTorch.

Welcome to the official implementation codebase for **CAMIE**, a post-hoc explanation framework for **multi-task molecular GNNs**.
